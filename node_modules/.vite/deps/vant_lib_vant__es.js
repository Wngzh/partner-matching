...
import {
  ...
  withDirectives,
  withKeys
} from "./chunk-IDB7W7II.js";
import "./chunk-5FUTL2UF.js";

// node_modules/vant/lib/vant.es.js
function noop() {
}
...
var isIOS$1 = () => inBrowser2 ? /ios|iphone|ipad|ipod/.test(navigator.userAgent.toLowerCase()) : false;
...
var [name$1K, bem$1F] = createNamespace("action-bar");
var ACTION_BAR_KEY = Symbol(name$1K);
var actionBarProps = {
  placeholder: Boolean,
...
var ActionBar = withInstall(stdin_default$1U);
...
var [name$1J, bem$1E] = createNamespace("badge");
var badgeProps = {
  dot: Boolean,
  max: numericProp,
...
var Badge = withInstall(stdin_default$1T);
var globalZIndex = 2e3;
var useGlobalZIndex = () => ++globalZIndex;
var setGlobalZIndex = (val) => {
  globalZIndex = val;
};
var [name$1I, bem$1D] = createNamespace("config-provider");
var CONFIG_PROVIDER_KEY = Symbol(name$1I);
...
var [name$1H, bem$1C] = createNamespace("icon");
...
var Icon = withInstall(stdin_default$1R);
var stdin_default$1Q = Icon;
var [name$1G, bem$1B] = createNamespace("loading");
...
var Loading = withInstall(stdin_default$1P);
var [name$1F, bem$1A] = createNamespace("button");
...
var Button = withInstall(stdin_default$1O);
var [name$1E, bem$1z] = createNamespace("action-bar-button");
...
var ActionBarButton = withInstall(stdin_default$1N);
var [name$1D, bem$1y] = createNamespace("action-bar-icon");
...
var ActionBarIcon = withInstall(stdin_default$1M);
...
var [name$1C, bem$1x] = createNamespace("overlay");
var overlayProps = {
  show: Boolean,
  zIndex: numericProp,
  duration: numericProp,
...
var Overlay = withInstall(stdin_default$1L);
...
var [name$1B, bem$1w] = createNamespace("popup");
...
var Popup = withInstall(stdin_default$1K);
var [name$1A, bem$1v] = createNamespace("action-sheet");
...
var ActionSheet = withInstall(stdin_default$1J);
var [name$1z, bem$1u, t$k] = createNamespace("picker");
...
var [name$1y, bem$1t] = createNamespace("picker-column");
var PICKER_KEY = Symbol(name$1y);
...
var [name$1x] = createNamespace("picker-toolbar");
...
var Sticky = withInstall(stdin_default$1G);
var [name$1v, bem$1r] = createNamespace("swipe");
var swipeProps = {
  loop: truthProp,
  width: numericProp,
  height: numericProp,
...
var Swipe = withInstall(stdin_default$1F);
var [name$1u, bem$1q] = createNamespace("tabs");
...
var [name$1t, bem$1p] = createNamespace("tabs");
var tabsProps = {
...
var [name$1s, bem$1o] = createNamespace("tab");
...
var [name$1r, bem$1n] = createNamespace("swipe-item");
...
var SwipeItem = withInstall(stdin_default$1C);
var [name$1q, bem$1m] = createNamespace("tab");
...
var Tab = withInstall(stdin_default$1B);
var Tabs = withInstall(stdin_default$1D);
var [name$1p, bem$1l] = createNamespace("picker-group");
var PICKER_GROUP_KEY = Symbol(name$1p);
...
var Picker = withInstall(stdin_default$1z);
var [name$1o, bem$1k] = createNamespace("area");
...
var Area = withInstall(stdin_default$1y);
var [name$1n, bem$1j] = createNamespace("cell");
var cellSharedProps = {
  tag: makeStringProp("div"),
  icon: String,
  size: String,
...
var Cell = withInstall(stdin_default$1x);
var [name$1m, bem$1i] = createNamespace("form");
var formProps = {
  colon: Boolean,
  disabled: Boolean,
  readonly: Boolean,
...
var Form = withInstall(stdin_default$1w);
...
var [name$1l, bem$1h] = createNamespace("field");
...
var Field = withInstall(stdin_default$1v);
var lockCount = 0;
...
var [name$1k, bem$1g] = createNamespace("toast");
var popupInheritProps$1 = ["show", "overlay", "teleport", "transition", "overlayClass", "overlayStyle", "closeOnClickOverlay", "zIndex"];
var toastProps = {
  icon: String,
  show: Boolean,
  type: makeStringProp("text"),
...
var Toast = withInstall(stdin_default$1u);
var [name$1j, bem$1f] = createNamespace("switch");
var switchProps = {
  size: numericProp,
  loading: Boolean,
  disabled: Boolean,
...
var Switch = withInstall(stdin_default$1t);
var [name$1i, bem$1e] = createNamespace("address-edit-detail");
var t$j = createNamespace("address-edit")[2];
var stdin_default$1s = defineComponent({
  name: name$1i,
  props: {
    show: Boolean,
...
var [name$1h, bem$1d, t$i] = createNamespace("address-edit");
var DEFAULT_DATA = {
  name: "",
  tel: "",
  city: "",
...
var AddressEdit = withInstall(stdin_default$1r);
var [name$1g, bem$1c] = createNamespace("radio-group");
var radioGroupProps = {
  shape: String,
  disabled: Boolean,
  iconSize: numericProp,
...
var RadioGroup = withInstall(stdin_default$1q);
var [name$1f, bem$1b] = createNamespace("checkbox-group");
...
var CHECKBOX_GROUP_KEY = Symbol(name$1f);
var stdin_default$1p = defineComponent({
  name: name$1f,
...
var CheckboxGroup = withInstall(stdin_default$1p);
var [name$1e, bem$1a] = createNamespace("tag");
var tagProps = {
  size: String,
  mark: Boolean,
  show: truthProp,
...
var Tag = withInstall(stdin_default$1o);
var checkerProps = {
  name: unknownProp,
  disabled: Boolean,
  iconSize: numericProp,
...
var [name$1d, bem$19] = createNamespace("radio");
var stdin_default$1m = defineComponent({
  name: name$1d,
  props: radioProps,
...
var Radio = withInstall(stdin_default$1m);
var [name$1c, bem$18] = createNamespace("checkbox");
...
var Checkbox = withInstall(stdin_default$1l);
var [name$1b, bem$17] = createNamespace("address-item");
var stdin_default$1k = defineComponent({
  name: name$1b,
  props: {
...
var [name$1a, bem$16, t$h] = createNamespace("address-list");
...
var [name$19, bem$15] = createNamespace("back-top");
var backTopProps = {
  right: numericProp,
  bottom: numericProp,
  zIndex: numericProp,
...
var BackTop = withInstall(stdin_default$1i);
...
var [name$18, bem$14] = createNamespace("barrage");
var stdin_default$1h = defineComponent({
  name: name$18,
  props: barrageProps,
  emits: ["update:modelValue"],
...
var Barrage = withInstall(stdin_default$1h);
var [name$17, bem$13, t$g] = createNamespace("calendar");
var formatMonthTitle = (date) => t$g("monthTitle", date.getFullYear(), date.getMonth() + 1);
...
var [name$16] = createNamespace("calendar-day");
var stdin_default$1g = defineComponent({
  name: name$16,
  props: {
...
var [name$15] = createNamespace("calendar-month");
...
var [name$14] = createNamespace("calendar-header");
var stdin_default$1e = defineComponent({
  name: name$14,
  props: {
    date: Date,
...
var Calendar = withInstall(stdin_default$1d);
var [name$13, bem$12] = createNamespace("image");
var imageProps = {
  src: String,
  alt: String,
  fit: String,
...
var Image$1 = withInstall(stdin_default$1c);
var [name$12, bem$11] = createNamespace("card");
var cardProps = {
  tag: String,
  num: numericProp,
  desc: String,
...
var Card = withInstall(stdin_default$1b);
var [name$11, bem$10, t$f] = createNamespace("cascader");
var cascaderProps = {
  title: String,
  options: makeArrayProp(),
  closeable: truthProp,
...
var Cascader = withInstall(stdin_default$1a);
var [name$10, bem$$] = createNamespace("cell-group");
var cellGroupProps = {
  title: String,
  inset: Boolean,
  border: truthProp
...
var CellGroup = withInstall(stdin_default$19);
var [name$$, bem$_] = createNamespace("circle");
var uid = 0;
...
var Circle = withInstall(stdin_default$18);
var [name$_, bem$Z] = createNamespace("row");
var ROW_KEY = Symbol(name$_);
var rowProps = {
  tag: makeStringProp("div"),
  wrap: truthProp,
  align: String,
...
var [name$Z, bem$Y] = createNamespace("col");
var colProps = {
  tag: makeStringProp("div"),
...
var Col = withInstall(stdin_default$16);
var [name$Y, bem$X] = createNamespace("collapse");
var COLLAPSE_KEY = Symbol(name$Y);
var collapseProps = {
  border: truthProp,
  accordion: Boolean,
  modelValue: {
...
var Collapse = withInstall(stdin_default$15);
var [name$X, bem$W] = createNamespace("collapse-item");
...
var CollapseItem = withInstall(stdin_default$14);
var ConfigProvider = withInstall(stdin_default$1S);
var [name$W, bem$V, t$e] = createNamespace("contact-card");
...
var ContactCard = withInstall(stdin_default$13);
var [name$V, bem$U, t$d] = createNamespace("contact-edit");
var DEFAULT_CONTACT = {
  tel: "",
  name: ""
};
...
var ContactEdit = withInstall(stdin_default$12);
var [name$U, bem$T, t$c] = createNamespace("contact-list");
...
var ContactList = withInstall(stdin_default$11);
...
var [name$T, bem$S] = createNamespace("count-down");
var countDownProps = {
...
var CountDown = withInstall(stdin_default$10);
...
var [name$S, bem$R, t$b] = createNamespace("coupon");
...
var Coupon = withInstall(stdin_default$$);
var [name$R, bem$Q, t$a] = createNamespace("coupon-cell");
var couponCellProps = {
  title: String,
  border: truthProp,
  editable: truthProp,
...
var CouponCell = withInstall(stdin_default$_);
var [name$Q, bem$P] = createNamespace("empty");
var emptyProps = {
...
var Empty = withInstall(stdin_default$Z);
var [name$P, bem$O, t$9] = createNamespace("coupon-list");
var couponListProps = {
  code: makeStringProp(""),
  coupons: makeArrayProp(),
  currency: makeStringProp("¥"),
...
var CouponList = withInstall(stdin_default$Y);
var currentYear = (/* @__PURE__ */ new Date()).getFullYear();
var [name$O] = createNamespace("date-picker");
...
var DatePicker = withInstall(stdin_default$X);
var [name$N, bem$N, t$8] = createNamespace("dialog");
...
var currentOptions$1 = extend({}, DEFAULT_OPTIONS);
...
var Dialog = withInstall(stdin_default$W);
var [name$M, bem$M] = createNamespace("divider");
var dividerProps = {
  dashed: Boolean,
  hairline: truthProp,
  vertical: Boolean,
...
var Divider = withInstall(stdin_default$V);
var [name$L, bem$L] = createNamespace("dropdown-menu");
...
var DROPDOWN_KEY = Symbol(name$L);
...
var [name$K, bem$K] = createNamespace("dropdown-item");
...
var DropdownItem = withInstall(stdin_default$T);
var DropdownMenu = withInstall(stdin_default$U);
...
var [name$J, bem$J] = createNamespace("floating-bubble");
...
var FloatingBubble = withInstall(stdin_default$S);
...
var [name$I, bem$I] = createNamespace("floating-panel");
...
var FloatingPanel = withInstall(stdin_default$R);
var [name$H, bem$H] = createNamespace("grid");
var gridProps = {
  square: Boolean,
  center: truthProp,
  border: truthProp,
...
var Grid = withInstall(stdin_default$Q);
var [name$G, bem$G] = createNamespace("grid-item");
...
var GridItem = withInstall(stdin_default$P);
var [name$F, bem$F] = createNamespace("highlight");
var highlightProps = {
...
var Highlight = withInstall(stdin_default$O);
...
var bem$E = createNamespace("image-preview")[1];
...
var [name$E, bem$D] = createNamespace("image-preview");
var popupProps$1 = ["show", "teleport", "transition", "overlayStyle", "closeOnPopstate"];
...
var ImagePreview = withInstall(stdin_default$M);
function genAlphabet() {
  const charCodeOfA = "A".charCodeAt(0);
  const indexList = Array(26).fill("").map((_, i) => String.fromCharCode(charCodeOfA + i));
  return indexList;
}
var [name$D, bem$C] = createNamespace("index-bar");
var indexBarProps = {
  sticky: truthProp,
  zIndex: numericProp,
  teleport: [String, Object],
...
var INDEX_BAR_KEY = Symbol(name$D);
...
var [name$C, bem$B] = createNamespace("index-anchor");
...
var IndexAnchor = withInstall(stdin_default$K);
var IndexBar = withInstall(stdin_default$L);
var [name$B, bem$A, t$7] = createNamespace("list");
var listProps = {
  error: Boolean,
...
var List = withInstall(stdin_default$J);
var [name$A, bem$z] = createNamespace("nav-bar");
var navBarProps = {
  title: String,
  fixed: Boolean,
  zIndex: numericProp,
...
var NavBar = withInstall(stdin_default$I);
var [name$z, bem$y] = createNamespace("notice-bar");
var noticeBarProps = {
  text: String,
  mode: String,
  color: String,
...
var NoticeBar = withInstall(stdin_default$H);
var [name$y, bem$x] = createNamespace("notify");
var popupInheritProps = ["lockScroll", "position", "show", "teleport", "zIndex"];
...
var Notify = withInstall(stdin_default$G);
var [name$x, bem$w] = createNamespace("key");
...
var [name$w, bem$v] = createNamespace("number-keyboard");
...
var NumberKeyboard = withInstall(stdin_default$E);
var [name$v, bem$u, t$6] = createNamespace("pagination");
...
var Pagination = withInstall(stdin_default$D);
var [name$u, bem$t] = createNamespace("password-input");
...
var PasswordInput = withInstall(stdin_default$C);
var PickerGroup = withInstall(stdin_default$1A);
var [name$t, bem$s] = createNamespace("popover");
var popupProps = ["overlay", "duration", "teleport", "overlayStyle", "overlayClass", "closeOnClickOverlay"];
var popoverProps = {
  show: Boolean,
  theme: makeStringProp("light"),
  overlay: Boolean,
...
var Popover = withInstall(stdin_default$B);
var [name$s, bem$r] = createNamespace("progress");
var progressProps = {
  color: String,
  inactive: Boolean,
  pivotText: String,
...
var Progress = withInstall(stdin_default$A);
var [name$r, bem$q, t$5] = createNamespace("pull-refresh");
...
var PullRefresh = withInstall(stdin_default$z);
var [name$q, bem$p] = createNamespace("rate");
...
var Rate = withInstall(stdin_default$y);
var props = {
...
var [name$p, bem$o] = createNamespace("rolling-text-item");
var stdin_default$x = defineComponent({
  name: name$p,
  props,
  setup(props2) {
...
var [name$o, bem$n] = createNamespace("rolling-text");
...
var RollingText = withInstall(stdin_default$w);
var Row = withInstall(stdin_default$17);
var [name$n, bem$m, t$4] = createNamespace("search");
...
var Search = withInstall(stdin_default$v);
...
var [name$m, bem$l, t$3] = createNamespace("share-sheet");
...
var ShareSheet = withInstall(stdin_default$u);
var [name$l, bem$k] = createNamespace("sidebar");
var SIDEBAR_KEY = Symbol(name$l);
var sidebarProps = {
...
var Sidebar = withInstall(stdin_default$t);
var [name$k, bem$j] = createNamespace("sidebar-item");
...
var SidebarItem = withInstall(stdin_default$s);
var [name$j, bem$i, t$2] = createNamespace("signature");
var signatureProps = {
  tips: String,
...
var Signature = withInstall(stdin_default$r);
var [name$i, bem$h] = createNamespace("skeleton-title");
...
var SkeletonTitle = withInstall(stdin_default$q);
var stdin_default$p = SkeletonTitle;
var [name$h, bem$g] = createNamespace("skeleton-avatar");
...
var SkeletonAvatar = withInstall(stdin_default$o);
...
var [name$g, bem$f] = createNamespace("skeleton-paragraph");
var stdin_default$m = defineComponent({
  name: name$g,
...
var SkeletonParagraph = withInstall(stdin_default$m);
var stdin_default$l = SkeletonParagraph;
var [name$f, bem$e] = createNamespace("skeleton");
...
var Skeleton = withInstall(stdin_default$k);
var [name$e, bem$d] = createNamespace("skeleton-image");
...
var SkeletonImage = withInstall(stdin_default$j);
var [name$d, bem$c] = createNamespace("slider");
var sliderProps = {
...
var Slider = withInstall(stdin_default$i);
var [name$c, bem$b] = createNamespace("space");
var spaceProps = {
  align: String,
  direction: {
    type: String,
...
var Space = withInstall(stdin_default$h);
var [name$b, bem$a] = createNamespace("steps");
var stepsProps = {
  active: makeNumericProp(0),
...
var [name$a, bem$9] = createNamespace("step");
var stdin_default$f = defineComponent({
  name: name$a,
  setup(props2, {
    slots
...
var Step = withInstall(stdin_default$f);
...
var Stepper = withInstall(stdin_default$e);
var Steps = withInstall(stdin_default$g);
...
var SubmitBar = withInstall(stdin_default$d);
...
var SwipeCell = withInstall(stdin_default$c);
...
var Tabbar = withInstall(stdin_default$b);
...
var TabbarItem = withInstall(stdin_default$a);
...
//# sourceMappingURL=vant_lib_vant__es.js.map
